...
context('Actions', () => {
    ...
    it('.rightclick() - right click on a DOM element', () => {
        ...
        cy.get('.rightclick-action-div')
            .rightclick()
            .should('not.be.visible');
        cy.get('.rightclick-action-input-hidden').should(
            'be.visible',
        );
    });
    ...
    it('.scrollIntoView() - scroll an element into view', () => {
        ...
        cy.get('#scroll-horizontal button').should(
            'not.be.visible',
        );
        ...
        cy.get('#scroll-vertical button').should(
            'not.be.visible',
        );
        ...
        cy.get('#scroll-both button').should(
            'not.be.visible',
        );
